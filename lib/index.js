...
function shouldClearCache(
  ...
  if (!compilationStartedTimestamp || !dependencies) return false
...
class SimplePrerenderWebpackPlugin {
  ...
  apply(compiler) {
    ...
    compiler.hooks.make.tapPromise(
      ...
      compilation => {
        ...
        result = runChildCompiler(childCompiler, this.opts.writeToDisk).then(
          childCompilation => {
            dependencies = Array.from(childCompilation.fileDependencies)
    ...
    compiler.hooks.thisCompilation.tap(PLUGIN_NAME, compilation => {
      // copy from https://github.com/jantimon/html-webpack-plugin/blob/24e4f1067c8d064e451a7d64f8c24f4118d8bf37/index.js#L132
      if (
